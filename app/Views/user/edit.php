                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="tipe-item">
                                <option selected value="<?php echo $tipetesis['id'] ?>"><?php echo $tipetesis['nama']; ?></option>
                                <?php foreach ($tipeall as $tipe) : ?>
            ...
            <div class="tab">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-7">
                        <div class="row">
                            <div class="col">
                                <input type="text" class="form-control" placeholder="First name" aria-label="First name" name="firstname_author" value="<?php echo $dokumen['penulis_depan']; ?>">
                            </div>
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Last name" aria-label="Last name" name="lastname_author" value="<?php echo $dokumen['penulis_belakang']; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                            ...
                            <?php foreach ($author as $auth) : ?>
                                <div class="authors-list">
                                    <div class="left-author">
                                        <p><?php echo $auth['nama_depan'] ?> <?php echo $auth['nama_belakang']; ?></p>
                                        <input type="hidden" class="harus" name="namadepan<?php echo $auth['id']; ?>" value="<?php echo $auth['nama_depan']; ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control harus" id="judul" name="judul" value="<?php echo $dokumen['judul']; ?>">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="abstrak" class="col-sm-2 col-form-label">Abstrak*</label>
                    <div class="col-sm-7">
                        <input type="textarea" class="form-control harus" id="abstrak" name="abstrak" value="<?php echo $dokumen['abstrak']; ?>">
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-7">
                        <select class="custom-select harus" id="jendok" name="jendok">
                            <option selected value="<?php echo $jendok['id']; ?>"><?php echo $jendok['nama']; ?></option>
                            <?php foreach ($jendokall as $je) : ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-7">
                        <select class="custom-select harus" id="jenjang" name="jenjang">
                            <option selected value="<?php echo $jenjang['id']; ?>"><?php echo $jenjang['nama']; ?></option>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <select class="custom-select harus" id="fakultas" name="fakultas">
                            <option selected value="<?php echo $fakultas['id']; ?>"><?php echo $fakultas['nama']; ?></option>
                            <?php foreach ($fakultasall as $f) : ?>
                    ...
                    <div class="col-sm-5">
                        <select class="custom-select harus" id="jurusan" name="jurusan">
                            <option selected value="<?php echo $jurusan['id']; ?>"><?php echo $jurusan['nama']; ?></option>
                            <?php foreach ($jurusanall as $ju) : ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control harus" id="dospem" name="dospem" value="<?php echo $dokumen['dosen_pembimbing']; ?>">
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-7">
                        <select id="status" class="custom-select mr-sm-2 harus" name="status">
                            <option selected value="<?php echo $dokumen['status']; ?>"><?php echo $dokumen['status']; ?></option>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-7">
                        <input type="date" class="form-control harus" id="tgl_publikasi" name="tgl_publikasi" value="<?php echo $tanggal; ?>">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="kata_kunci" class="col-sm-2 col-form-label">Kata Kunci</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="kata_kunci" name="kata_kunci" value="<?php echo $dokumen['kata_kunci']; ?>">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="referensi" class="col-sm-2 col-form-label">Referensi</label>
                    <div class="col-sm-7">
                        <input type="textarea" class="form-control" id="referensi" name="referensi" value="<?php echo $dokumen['referensi']; ?>">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="email" class="col-sm-2 col-form-label">Email*</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control harus" id="email" name="email" value="<?php echo $dokumen['email']; ?>">
                    </div>
                </div>
            </div>
            <div class="tab">
                <center>
                    ...
                    <select class="custom-select mr-sm-2" aria-label="Default select example" id="selectsubjek">
                        <option selected value="<?php echo $subsubjek['id_subjek']; ?>"><?php echo $subjek['nama']; ?></option>
                    ...
                    <select class="custom-select mr-sm-2 mt-3" aria-label="Default select example" id="subsubjek1" name="subsubjek1">
                        <option selected value="<?php echo $subsubjek['id']; ?>"><?php echo $subsubjek['nama']; ?></option>
