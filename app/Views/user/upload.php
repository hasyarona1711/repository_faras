            ...
            <div class="tab">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group mb-3">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="uploaded-files" name="uploaded-files">
                                    <label class="custom-file-label" for="uploaded-files"></label>
                                </div>
                ...
                <div id="file-container" style="min-width: 750px;">
                    <!-- <div class="files-list">
                        <div class="left">
                            <p>Judul File</p><input type="hidden">
                        </div>
                        <div class="right">
                            <button type="button" class="settingbtn">Settings</button>
                            <button class="deletebtn"><i class="fa fa-trash-o" aria-hidden="true"></i>Delete</button>
                        </div>
                    </div> -->
                </div>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fs-5" id="settingModalLabel"></h5>
                <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <form action="/dokumen/saveFile" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <input type="hidden" id="namauploadfile" name="namauploadfile">
                    <input type="hidden" id="sizeuploadfile" name="sizeuploadfile">
                    <div class="mb-3">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="submit-modal">Submit</button>
                </div>
            </form>
        </div>
    </div>
